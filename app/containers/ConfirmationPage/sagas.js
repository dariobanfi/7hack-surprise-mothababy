...
export function* getProducts() {
  ...
  const makeUrl = (categoryId) => `http://stylight.instigator.io/products?apiKey=H6490912AB3211E680F576304DEC7EB7&page_items=50&sort_by=relevance&occasion=${occasion}&gender=men&category=${categoryId}`
